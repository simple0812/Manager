const mockData = [
  ...
  {id: 2, name:'财务系统', icon:'pie-chart', submenus:[
    {id: 21, name:'人事行政', icon:'pie-chart', submenus:[]},
    {id: 22, name:'人事行政', icon:'pie-chart', submenus:[]},
    {id: 23, name:'人事行政', icon:'pie-chart', submenus:[]},
    {id: 24, name:'公共信息', icon:'pie-chart', submenus:[]},
    {id: 25, name:'投票管理', icon:'pie-chart', submenus:[]},
  ]},
