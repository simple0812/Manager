...
class Main extends React.Component  {
  ...
  render() {
    return (
      ...
      <Card className='login-info-box' title={<b style={{fontSize:12, color:'#525252'}}>登录信息</b>} 
        extra={<a href="#" style={{ color: '#525252' }}>更多</a>} style={{ width: 410 }}>
        ...
        <Card className='birthday-box' title={<b style={{fontSize:12, color:'#525252'}}>本月寿星</b>} 
          extra={<a href="#" style={{ color: '#525252' }}>更多</a>} style={{ width: 410 }}>
